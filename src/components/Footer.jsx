...
const Footer = () => {
    return (
        <div className='footer-wrapper w-ful p-20 pb-10'>
            <div className='footer-col flex gap-10'>
                <div className='footer-title'>
                    <h2 className='text-zinc-100 font-[FoundersGrotesk] text-[10vw] w-1/2 leading-[0.7] uppercase'>EYE-OPENING</h2>
                </div>
                <div className='footer-links '>
                    <div className='links-title'>
                        <h2 className='text-zinc-100 font-[FoundersGrotesk] text-[10vw] w-1/2 leading-[0.7] uppercase'>presentations</h2>
                    </div>
                    <div className='footer-link-wrap mt-20'>
                        <div className='link-title mb-10'>
                            <h5 className='font-[NeueMontreal] text-2xl'>S:</h5>
                        </div>
                        <div className='flex gap-5 flex-col'>
                            {["Instagram", "Behance", "Facebook", "Linkdin"].map((item, index) => (
                                <a className="font-[NeueMontreal] text-2xl underline leading-2" href='#'>{item}</a>
                            ))}
                        </div>
                    </div>
                    <div className='flex gap-10 justify-between relative'>
                        <div className='footer-link-wrap mt-20 w-[25%]'>
                            <div className='link-title mb-10'>
                                <h5 className='font-[NeueMontreal] text-2xl'>L:</h5>
                            </div>
                            <div className='flex gap-5 flex-col'>
                                {["202-1965 W 4th Ave Vancouver,Canada", "30 Chukaria St Lviv, Ukrain"].map((item, index) => (

                                    <a className="font-[NeueMontreal] text-2xl underline leading-2" href='#'>{item}</a>

                                ))}
                            </div>
                            <div className='link-title mb-2 mt-20'>
                                <h5 className='font-[NeueMontreal] text-2xl'>E:</h5>
                            </div>
                            <div className='flex gap-5 flex-col'>
                        ...
                        <div className='footer-link-wrap mt-20 w-[75%] flex justify-end flex-col items-end '>
                            <div className='link-title mb-10 w-[17%] '>
                                <h5 className='font-[NeueMontreal] text-2xl'>M:</h5>
                            </div>
                            <div className='flex gap-5 flex-col'>
            ...
            <div className='footer-bottom pt-20 flex gap-10 items-center justify-between'>
                ...
                <div className='footer-copyright w-[60%]'>
                    <div className='footer-flex-wrap flex justify-between w-full'>
                        {["© ochi design 2024. Legal Terms", "Website by Obys"].map((item, index) => (
                            <a href="#">{item}</a>
                        ))}
                    </div>
                </div>
